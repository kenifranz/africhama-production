...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'approve') {
        ...
        $stmt = $conn->prepare("UPDATE notifications SET is_read = 1 WHERE user_id = ? AND type = 'topup' AND link LIKE '%admin_approve_topups.php'");
    ...
    header("Location: " . $base_path . "/admin_approve_topups.php");
    exit();
}
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" style="display: inline;">
                                ...
                                <button type="submit" name="action" value="approve" class="btn btn-success btn-sm approve-button">Approve</button>
                                <button type="submit" name="action" value="reject" class="btn btn-danger btn-sm reject-button">Reject</button>
                            </form>
                        </td>
                    </tr>
                <?php endforeach; ?>
